package collections.Set.TreeSet.addAll;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(Collections.min(sortedStudents, sortedStudents.comparator()));
        System.out.println(Collections.max(sortedStudents, sortedStudents.comparator()));
